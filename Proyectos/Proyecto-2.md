...
### Fecha de entrega: viernes 7 de enero, 2022
...
![ejemplo-svg](uploads/ef173e9e49f3762a8559469db82515ba/ejemplo-svg.png)
...
![lista-svg](uploads/db02699ef09ee205a1c29c4b8b49f974/lista-svg.png)

Los árboles binarios, de la siguiente:

![arbol-svg](uploads/40b2deae7ebf39939f0fc878e3ab37cf/arbol-svg.png)

Los árboles rojinegros de la siguiente:

![arbol-rn-svg](uploads/604c22c2b5814cbbef21e17b8cf4dc36/arbol-rn-svg.png)

Y los árboles AVL de la siguiente:

![arbol-avl-svg](uploads/76d775055f1c73623823299d589a6742/arbol-avl-svg.png)
...
4. Después del nombre de clase deben venir enteros (*siempre* enteros) que son
   los elementos de la estructura. Pueden suponer que los enteros estarán entre
   0 y 99 (pero pueden repetirse).
...
5. Su programa debe ser robusto frente a errores: si no pueden leer el archivo;
   el mismo no existe; si se les proporciona un archivo con el formato
   incorrecto; o uno con ligeros errores, el programa no debe lanzar una
   excepción. Se debe mostrar un mensaje (al error estándar) explicando qué
   ocurrió, y terminar con gracia.
